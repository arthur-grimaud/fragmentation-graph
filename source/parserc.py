...
import re
import gzip
from source.spectrumfile import SpectrumFile
...
class Parser:
    ...
    def read(self, raw_file, ident_file, file_format, max_rank=RANK_LIMIT, min_spectra=0, max_spectra=1):
        ...
        count = 0
        self.psm_list = self.psm_list[
            int(len(self.psm_list) * min_spectra) : int(len(self.psm_list) * max_spectra)
        ]
